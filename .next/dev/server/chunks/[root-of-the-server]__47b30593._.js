...
async function POST(request) {
    try {
        ...
        const existingUsers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id FROM users WHERE email = ?", [
            email
        ]);
        ...
        // Create user
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("INSERT INTO users (email, password_hash, name) VALUES (?, ?, ?)", [
            email,
            hashedPassword,
            name
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__47b30593._.js.map