...
async function GET(request) {
    try {
        ...
        // Category breakdown
        const categoryData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(`SELECT c.name, SUM(t.amount) as total 
       FROM transactions t 
       ...
       GROUP BY c.name`, [
        ...
        // Income vs Expense
        const incomeVsExpense = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(`SELECT type, SUM(amount) as total 
       FROM transactions 
       ...
       GROUP BY type`, [
        ...
        // Monthly trend
        const monthlyTrend = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(`SELECT DATE_FORMAT(date, '%Y-%m') as month, type, SUM(amount) as total 
       FROM transactions 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86e3c640._.js.map