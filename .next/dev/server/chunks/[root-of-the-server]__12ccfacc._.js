...
async function GET(request) {
    try {
        ...
        const budgets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(`SELECT b.*, c.name as category_name, 
       ...
       GROUP BY b.id`, [
        ...
        const mapped = Array.isArray(budgets) ? budgets.map((b)=>{
...
async function POST(request) {
    try {
        ...
        if (!resolvedCategoryId && category) {
            const categoryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id FROM categories WHERE name = ? AND (user_id = ? OR user_id IS NULL)", [
                category,
                userId
            ]);
            resolvedCategoryId = Array.isArray(categoryResult) && categoryResult[0] ? categoryResult[0].id : null;
        }
        const insertMonth = month || new Date().toISOString().slice(0, 10);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("INSERT INTO budgets (user_id, category_id, month, amount) VALUES (?, ?, ?, ?)", [
            userId,
            resolvedCategoryId,
            insertMonth,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12ccfacc._.js.map