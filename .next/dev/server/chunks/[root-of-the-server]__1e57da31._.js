...
async function GET(request) {
    try {
        ...
        const goals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id, title, target_amount, current_amount, deadline FROM savings_goals WHERE user_id = ? ORDER BY deadline ASC", [
            userId
        ]);
        const mapped = Array.isArray(goals) ? goals.map((g)=>{
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("INSERT INTO savings_goals (user_id, title, target_amount, current_amount, deadline) VALUES (?, ?, ?, ?, ?)", [
            userId,
            title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e57da31._.js.map